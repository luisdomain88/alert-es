...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MHNG63W6"
...
<div id="footer" style="position:absolute; bottom:0px; cursor:none">
    <div class="row">
        <div class="col-md-12">
...
<script src="npm/bootstrap-4.6.0/dist/js/bootstrap.bundle.min.js"
        ></script>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".pro_box2").delay(1000).fadeIn(800);
        $(".chat").delay(1000).fadeIn(800);
